export function createRateLimiter(options = {}) {
    const { windowMs = 60_000, max = 30, keyGenerator, skip, message = "Too many requests. Slow down.", statusCode = 429, cleanupIntervalMs = 5 * 60_000, staleAfterMs = windowMs * 2, maxKeys = 10_000, } = options;
    const hits = new Map();
