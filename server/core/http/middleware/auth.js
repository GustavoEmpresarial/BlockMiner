...
import { buildPrismaAwareErrorBody, isPrismaConnectionError, prismaAwareHttpStatus, unknownErrorMessage, } from "../../../shared/errors/prismaHttpErrors.js";
...
async function denyAnonymousSession(req, res, userId) {
...
export async function requireAuth(req, res, next) {
    try {
        ...
        const tokenSessionVersion = payload && typeof payload !== "string" ? payload.sv : undefined;
        ...
        if (await denyAnonymousSession(req, res, user.id))
            return;
        req.user = user;
        next();
    }
