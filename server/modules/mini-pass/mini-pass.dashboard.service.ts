...
import { pickMiniPassI18n } from "./mini-pass.i18n.js";
import { computePassLevel, xpCapForSeason, xpRemainingToCap } from "./mini-pass.level-math.js";
import { resolveMissionPeriodKey } from "./mini-pass.period.js";
import { getMiniPassSeasonState } from "./mini-pass.season-live.js";
function asI18n(obj) {
...
function mapRewardRow(r, langHeader) {
    return {
        ...
        title: pickMiniPassI18n(asI18n(r.titleI18n), langHeader),
        minerId: r.minerId,
...
function mapMissionRow(m, prog, langHeader) {
    ...
    return {
        ...
        xpReward: m.xpReward,
        gameSlug: m.gameSlug,
        title: pickMiniPassI18n(asI18n(m.titleI18n), langHeader),
        description: pickMiniPassI18n(asI18n(m.descriptionI18n), langHeader),
    };
}
export async function listLiveMiniPassSeasons(langHeader) {
    ...
    return rows
        ...
        id: s.id,
        slug: s.slug,
        title: pickMiniPassI18n(asI18n(s.titleI18n), langHeader),
        subtitle: pickMiniPassI18n(asI18n(s.subtitleI18n), langHeader),
...
export async function getMiniPassSeasonDashboard(userId, seasonId, langHeader) {
    ...
    const periodKeys = [
        ...new Set(season.missions.map((m) => resolveMissionPeriodKey(m.cadence, m.missionType, now))),
    ];
    ...
    return {
        ...
        season: {
            ...
            slug: season.slug,
            state: seasonState,
            title: pickMiniPassI18n(asI18n(season.titleI18n), langHeader),
            subtitle: pickMiniPassI18n(asI18n(season.subtitleI18n), langHeader),
