...
miniPassRouter.post("/seasons/:seasonId/claim/:levelRewardId", requireAuth, writeLimiter, miniPass.postClaimMiniPassReward);
miniPassRouter.post("/seasons/:seasonId/buy-level", requireAuth, writeLimiter, miniPass.postBuyMiniPassLevels);
miniPassRouter.post("/seasons/:seasonId/complete-pass", requireAuth, writeLimiter, miniPass.postCompleteMiniPass);
