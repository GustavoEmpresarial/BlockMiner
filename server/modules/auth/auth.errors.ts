...
export const AUTH_LOGIN_MESSAGES = {
  ...
  USERSCRIPT_MANAGER_BLOCKED:
    "Tampermonkey ou Violentmonkey detectado. Remova a extensão do navegador e faça login novamente.",
} as const;

export type AuthFailureJson = { ok: false; code: string; message: string; error: string };
