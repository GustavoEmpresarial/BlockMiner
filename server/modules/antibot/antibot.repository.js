import { ALERT_DEVICE_ACCOUNT_THRESHOLD, ALERT_RISK_THRESHOLD, MAX_SCORE, SCORE_WINDOW_DAYS, computeScoreFromActiveCodes, resolveWeight, } from "./antibot.weights.js";
...
export async function getOrCreateProfile(prisma, userId) {
...
export async function computeWindowedScore(prisma, userId, now = new Date()) {
 ...
 */
export async function persistEvidence(prisma, input) {
    const now = new Date();
...
function evidenceRow(input, e, scoreBefore, scoreAfter) {
    return {
        userId: input.userId,
...
export async function setUserTrusted(prisma, userId, trusted) {
...
export async function setUserTrustedReason(prisma, userId, reason) {
...
export async function recomputeUserScore(prisma, userId) {
    const now = new Date();
...
export async function upsertDevice(prisma, data) {
...
export async function recountDeviceAccounts(prisma, deviceId) {
...
export async function maybeCreateAlert(prisma, alert) {
...
export function shouldAlertRisk(score) {
    return score >= ALERT_RISK_THRESHOLD;
}
/** True when a device is shared by too many accounts. */
export function shouldAlertSharedDevice(accountCount) {
...
// ---------------------------------------------------------------------------
export async function adminOverviewData(prisma, limit) {
...
export async function listEvidencePaginated(prisma, filters, page, limit) {
    const where = {
...
export async function listSessionsPaginated(prisma, filters, page, limit) {
    const where = {
        ...(filters.userId ? { userId: filters.userId } : {}),
...
export async function listDevicesPaginated(prisma, minAccounts, page, limit) {
...
export async function listAlertsPaginated(prisma, filters, page, limit) {
    const where = {
...
export async function updateAlertStatus(prisma, id, status) {
    const data = { status };
...
export async function getUserFullProfile(prisma, userId, evidenceLimit) {
 ...
 */
export async function clearAllAntibotData(prisma) {
 ...
 */
export async function insertTelemetryEvidence(prisma, input) {
    ...
    await prisma.antibotEvidence.create({
        data: {
            ...
            severity: "info",
            ip: input.ip || null,
            metadata: { telemetry: input.telemetry, userAgent: input.userAgent },
        },
    });
    return true;
}
export async function listRecentEvidence(prisma, limit) {
...
export async function countEvidence(prisma) {
    return prisma.antibotEvidence.count();
}
export async function countDistinctUsersWithEvidence(prisma) {
