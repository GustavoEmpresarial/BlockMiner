...
export function parseEventMinerDisplayName(minerName) {
    const raw = String(minerName ?? "").trim();
    if (!raw || !EVENT_PREFIX_RE.test(raw))
        return null;
