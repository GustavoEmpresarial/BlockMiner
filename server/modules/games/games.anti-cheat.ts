 ...
 */
export const GAME_MAX_SCORE_PER_SEC: Record<string, number> = {
  "crypto-memory": 8,
  "crypto-match-3": 120,
  "sky-runner": 4,
  "cart-rush": 80,
...
export type AntiCheatEvent = "timing_below_minimum" | "score_anomaly" | "replay_detected" | "action_flood";
...
export function evaluateCartRushTrust(elapsedMs: number, distance: number, btcCount: number, score: number): TrustResult {
  let trustScore = 100;
