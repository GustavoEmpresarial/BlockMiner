...
export async function claimGPUTx(tx: TxClient, gpuId: number, claimedAt: Date, expiresAt: Date) {
...
export async function decrementSecondsBalanceTx(tx: TxClient, userId: number, amount: number) {
