 ...
 */
import { windowContains, type TournamentRecord, type ContributionDelta, type TournamentActionPayload } from "./tournaments.types.js";
import {
  contributionSourceId,
  providerAllowedForMetric,
  TOURNAMENT_ACTION_PROVIDER,
} from "./tournaments.providers.js";
import type { MetricScoreBreakdown, MetricScorer } from "./tournaments.scorer-types.js";
...
export function createClaimCountScorers(): MetricScorer[] {
  return [
