/**
 * Ported from legacy/server/middleware/sidebarFeatureGate.ts. Real backend middleware
 * (operational kill switch) — when an admin hides a sidebar item, the corresponding
 * backend routes start responding 403, not just the frontend menu entry.
 */
