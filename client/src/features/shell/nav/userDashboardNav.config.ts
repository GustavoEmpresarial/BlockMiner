...
export const USER_DASHBOARD_NAV_FALLBACK: PublicNavCategory[] = [
  ...
  },
  {
    ...
    //     faucet → internal-offerwall → offerwall → ptc → shortlinks → read-earn → youtube → auto-mining
    items: [
      { itemId: 'tournaments', labelKey: 'sidebar.tournaments', icon: 'Crosshair', path: '/tournaments' },
      ...
      { itemId: 'burn', labelKey: 'sidebar.burn', icon: 'Flame', path: '/burn' },
      { itemId: 'games', labelKey: 'sidebar.games', icon: 'Gamepad2', path: '/games' },
      {
        ...
        children: [
          ...
          { itemId: 'offerwall', labelKey: 'sidebar.offerwall', icon: 'Globe', path: '/offerwall' },
...
export const USER_DASHBOARD_SCREEN_MATRIX = [
  ...
  },
  {
    ...
    notes: 'Depósitos, saques; saldo sempre do backend.',
  },
  {
    screen: 'Suporte',
    module: 'support',
