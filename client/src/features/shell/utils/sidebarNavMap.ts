...
export const SIDEBAR_OFFERS_ATTENTION_PATH = '/offers';

export function isOffersAttentionPath(path: string | undefined | null): boolean {
  return path === SIDEBAR_OFFERS_ATTENTION_PATH;
}
...
export function mapApiCategoriesToMenu(
