...
import type { CheckinStatusPayload } from './checkin.types';
import { weiHexFromDecimalString } from './checkinHelpers';
import { getBrowserEthereumProvider } from '../wallet/walletProvider';
import {
  CheckinWalletError,
