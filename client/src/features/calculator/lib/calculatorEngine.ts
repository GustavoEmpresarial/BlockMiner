 ...
 * Ported from legacy/client/src/shared/utils/calculatorEngine.ts.
 *
 * Defaults mirror MiningEngine (MINING_POL_BLOCK_REWARD / MINING_BLOCK_INTERVAL_MINUTES).
 * Callers can override from live socket stats.
 */
...
export function calcSelectedHashRate(
  minerList: MinerListRow[],
