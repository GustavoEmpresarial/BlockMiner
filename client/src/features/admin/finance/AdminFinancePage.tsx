          ...
          {(status === 'approved' || status === 'processing') && (
            <div className="flex flex-wrap items-center gap-2">
              <input
                ...
                placeholder="Informe o tx hash da transferência (0x…)"
                disabled={busy}
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 rounded-xl bg-sky-500/20 border border-sky-500/30 px-4 py-2 text-xs font-black text-sky-300 transition-all hover:bg-sky-500/30 active:scale-95 disabled:opacity-40"
              >
              ...
              {status === 'approved' && (
                <button
                  ...
                  disabled={busy}
                  onClick={() => setRejectModalTarget(w)}
                  className="rounded-xl border border-red-500/30 bg-red-500/15 px-3 py-2 text-xs font-bold text-red-300 transition-colors hover:bg-red-500/25 disabled:opacity-40"
                >
                  Rejeitar
                </button>
              )}
