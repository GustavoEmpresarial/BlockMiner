...
export const ADMIN_MINER_IMAGE_PLACEHOLDER = '/media/brand/icon.webp';

const PLACEHOLDER_PATHS = new Set([ADMIN_MINER_IMAGE_PLACEHOLDER, '/media/icons/logo-placeholder.webp']);
