    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-4">
        ...
        <StatCard
          ...
          value={insights.bestDay ? `${formatPolAmount(insights.bestDay.total, locale)} POL` : '—'}
        ...
        <StatCard
          ...
          value={insights.lastEarning ? `${formatPolAmount(insights.lastEarning.total, locale)} POL` : '—'}
          sub={
            insights.lastEarning ? formatUtcChartDay(insights.lastEarning.date) : t('powerStats.charts.no_data')
          }
          icon={Clock}
