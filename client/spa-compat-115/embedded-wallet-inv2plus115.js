import{j as H,i as g,M as W,O as K,h as c,o as _,T as j,H as G,d as E,r as U,e as Y,b as N,C as m,I as V,l as C,W as h,k as L,J as q,K as v,a as k,E as O,S as X,R as J}from"./ConstantsUtil-inv2plus115.js";import{r as d,c as w,n as l,o as Q}from"./index-11-inv2plus115.js";import"./index-DdVUACMr.js";import{C as z}from"./abis-CVMCdrNl.js";import{e as Z,n as ee}from"./ref-cXFHdcyo.js";import"./index-L-cRgqzw.js";import{H as I}from"./HelpersUtil-CvVUWrOY.js";import"./index-ClmyjRGv.js";import"./index-C6r8l-L3.js";import"./index-D2XEi68E.js";import"./index-DdMyNqdm.js";import"./index-BplWKqpl.js";import{N as te}from"./NavigationUtil-DmfK5sOV.js";import"./index-inv2plus115.js";import"./ConstantsUtil-COJBkkkj.js";const ie=H`
  div {
    width: 100%;
  }
...
`;var y=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};const ne={sm:"md-regular",md:"lg-regular",lg:"lg-regular"},se={success:"sealCheck",error:"warning",warning:"exclamationCircle"};let u=class extends g{constructor(){super(...arguments),this.type="success",this.size="md",this.imageSrc=void 0,this.disabled=!1,this.href="",this.text=void 0}render(){return c`
    ...
    `}isV6(){return(V.get("dapp_smart_account_version")||"v6")==="v6"}toggleSmartAccountVersion(){V.set("dapp_smart_account_version",this.isV6()?"v7":"v6"),typeof window<"u"&&window?.location?.reload()}togglePreferredAccountTypeTemplate(){const t=this.network?.chainNamespace,i=m.checkIfSmartAccountEnabled(),r=_.getConnectorId(t);return!_.getAuthConnector()||r!==z.CONNECTOR_ID.AUTH||!i?null:(this.switched||(this.text=C(t)===h.ACCOUNT_TYPES.SMART_ACCOUNT?"Switch to your EOA":"Switch to your Smart Account"),c`
      <wui-list-item
        icon="swapHorizontal"
        ?rounded=${!0}
        ?chevron=${!0}
...
`;var x=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let p=class extends g{constructor(){super(),this.formRef=Z(),this.usubscribe=[],this.name="",this.error="",this.loading=v.state.loading,this.suggestions=v.state.suggestions,this.profileName=m.getAccountData()?.profileName,this.onDebouncedNameInputChange=k.debounce(t=>{t.length<4?this.error="Name must be at least 4 characters long":I.isValidReownName(t)?(this.error="",v.getSuggestions(t)):this.error="The value is not a valid username"}),this.usubscribe.push(v.subscribe(t=>{this.suggestions=t.suggestions,this.loading=t.loading}),m.subscribeChainProp("accountState",t=>{this.profileName=t?.profileName,t?.profileName&&(this.error="You already own a name")}))}firstUpdated(){this.formRef.value?.addEventListener("keydown",this.onEnterKey.bind(this))}disconnectedCallback(){super.disconnectedCallback(),this.usubscribe.forEach(t=>t()),this.formRef.value?.removeEventListener("keydown",this.onEnterKey.bind(this))}render(){return c`
      <wui-flex
...
`;var pe=function(e,t,i,r){var n=arguments.length,o=n<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,i):r,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")o=Reflect.decorate(e,t,i,r);else for(var a=e.length-1;a>=0;a--)(s=e[a])&&(o=(n<3?s(o):n>3?s(t,i,o):s(t,i))||o);return n>3&&o&&Object.defineProperty(t,i,o),o};let D=class extends g{render(){return c`
      ...
      >
        ...
        <wui-link
          @click=${()=>{k.openHref(te.URLS.FAQ,"_blank")}}
        >
          Learn more
    ...
    </wui-flex>`}redirectToAccount(){J.replace("Account")}};D.styles=ue;D=pe([w("w3m-register-account-name-success-view")],D);export{R as W3mApproveTransactionView,D as W3mRegisterAccountNameSuccess,p as W3mRegisterAccountNameView,$ as W3mSmartAccountSettingsView,B as W3mUpgradeWalletView};
